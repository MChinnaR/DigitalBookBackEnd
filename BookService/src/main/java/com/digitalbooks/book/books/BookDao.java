...
//	@Modifying
	...
	@Query(value = "SELECT * FROM books_base_data.book_base_data where active=0 && title like :title% && author_name like :author% && publisher like :publisher% || category like '%' && time_stamp between :fromDate and "
